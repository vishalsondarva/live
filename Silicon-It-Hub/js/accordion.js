	...
	initialize:function(){
		this.element.find(".accordion-title").bind("click",function(event){
			...
			if (!$(this).next().is(':visible')) {
				// $(this).closest(".col_custom").siblings().find(".accordion-title").removeClass("active");
				// $(this).closest(".col_custom").siblings().find(".accordion-content").slideUp();
				$(".accordion .col_custom, .accordion .col_accordion").siblings().find(".accordion-title").removeClass("active");
				$(".accordion .col_custom, .accordion .col_accordion").siblings().find(".accordion-content").slideUp();
